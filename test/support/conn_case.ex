defmodule MeleteWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use MeleteWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import MeleteWeb.ConnCase
    end
  end

  setup tags do
    Melete.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_account(%{conn: conn}) do
    account = Melete.PersonFixtures.account_fixture()
  ...
  def log_in_account(conn, account) do
    token = Melete.Person.generate_account_session_token(account)
