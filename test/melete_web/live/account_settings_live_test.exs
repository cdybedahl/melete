defmodule MeleteWeb.AccountSettingsLiveTest do
  ...
  describe "update email form" do
    ...
    test "updates the account email", %{conn: conn, password: password, account: account} do
      ...
      assert Person.get_account_by_email(account.email)
    end
  ...
  describe "update password form" do
    ...
    test "updates the account password", %{conn: conn, account: account, password: password} do
      ...
      assert Person.get_account_by_email_and_password(account.email, new_password)
    end
  ...
  describe "confirm email" do
    ...
    test "updates the account email once", %{conn: conn, account: account, token: token, email: email} do
      ...
      refute Person.get_account_by_email(account.email)
      assert Person.get_account_by_email(email)
