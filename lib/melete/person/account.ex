defmodule Melete.Person.Account do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Melete.Repo)
  ...
  """
  def valid_password?(%Melete.Person.Account{hashed_password: hashed_password}, password)
